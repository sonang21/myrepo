/* *************************************************************************
 * NAME : dbo.udp_orderdata_ord_now_cate_by_cate
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2018-05-15 15:03:59.24
 *        Modify: 2018-05-15 15:03:59.24
 *        Backup: 20180521_1737
 ************************************************************************* */

CREATE proc udp_orderdata_ord_now_cate_by_cate
	@sdate smalldatetime
,	@edate smalldatetime
,	@category varchar(12)
,	@shop_code int
