/* *************************************************************************
 * NAME : dbo.UP_MIG_PRICELIST
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2018-04-02 14:59:40.347
 *        Modify: 2018-04-18 09:24:02.41
 *        Backup: 20180521_1737
 ************************************************************************* */


CREATE PROCEDURE [dbo].[UP_MIG_PRICELIST]  @partition_no int = 1, @log_group varchar(50) = null
-- =============================================================================
...
;
    ...
    ******************************************************************************* */  
    ...
    ----------------------------------------------------------------------------
        ...
        BEGIN TRAN
        insert into ELOC2001.dbo.MIG_PRICELIST WITH(PAGLOCK)
               ( pl_no
				 , pl_modelno
				 , pl_vcode
				 , pl_category
