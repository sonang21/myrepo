/* *************************************************************************
 * NAME : dbo.udp_jca_ap_report_fee_list_sum_monthly_enuri_v3
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2014-04-11 18:02:42.633
 *        Modify: 2018-05-03 17:23:34.777
 *        Backup: 20180521_1737
 ************************************************************************* */

CREATE proc [dbo].[udp_jca_ap_report_fee_list_sum_monthly_enuri_v3]
	@year	smallint
,	@sale_flag char(1)
as
	set nocount on
