/* *************************************************************************
 * NAME : dbo.udp_jca_ap_report_ord_list_weekly_enuri_2
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2011-01-31 16:40:09.93
 *        Modify: 2018-05-03 17:23:34.297
 *        Backup: 20180521_1737
 ************************************************************************* */

CREATE proc [dbo].[udp_jca_ap_report_ord_list_weekly_enuri_2]
	@year smallint
as
	set nocount on
	...
	*/
	...
	order by b.as_week_sum_order desc, b.shop_vcode asc
