/* *************************************************************************
 * NAME : dbo.udp_jca_ap_report_ord_list_daily_enuri_3
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2011-04-11 13:56:49.313
 *        Modify: 2018-05-03 17:23:35.973
 *        Backup: 20180521_1737
 ************************************************************************* */

CREATE proc [dbo].[udp_jca_ap_report_ord_list_daily_enuri_3]
	@sdate datetime
,	@edate datetime
as
	set nocount on
			...
			(
				...
				(
					...
					(
						...
						--and		shop_vcode in(1733,5893,49,47,55,57,75,90,536,663,806,1289,1878,3539,4027,5217,974,5610,5910,6052,1719,6547,6361,374,6588,6508, 6620)
					) a
					left outer join tbl_ap_sales_fee_rate_default b on a.shop_vcode=b.shop_vcode and a.sale_date between s_date and e_date
					left outer join tbl_ap_sales_fee_rate_promotion c on a.shop_vcode = c.shop_vcode and a.sale_date = promotion_date
				) d
