/* *************************************************************************
 * NAME : dbo.udp_monitoring_team_agg_work_sel_case3
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2015-03-23 20:49:59.083
 *        Modify: 2017-02-06 14:38:26.723
 *        Backup: 20180521_1737
 ************************************************************************* */

CREATE proc udp_monitoring_team_agg_work_sel_case3
	@sdate smalldatetime
,	@edate smalldatetime
,	@order int
as
...
--		,	round(max(case monitor_no when 3 then uratio end), 1)
	...
	(
		...
		--and mm_id in ( --- 재택  or 모니터링팀 외 작업자가 있어서 파트 제외 쿼리는 삭제함. 2015.06.18
		--		select mm_id from mpdb02.member.dbo.mm_enuri b where mm_partcode like '_________41[12]'
		--)
		and monitor_no in (
