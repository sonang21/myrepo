/* *************************************************************************
 * NAME : dbo.udp_shop_special_goods_sel
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2013-11-20 17:28:22.817
 *        Modify: 2018-05-03 17:23:34.9
 *        Backup: 20180521_1737
 ************************************************************************* */

CREATE  PROC [dbo].[udp_shop_special_goods_sel]
	@sdate datetime
,	@group_flag char(1)
...
AS 
	...
	*/
	...
	,		g_modelnm
	,		pl_note
	from tbl_shop_special_goods a inner join pricelist b
