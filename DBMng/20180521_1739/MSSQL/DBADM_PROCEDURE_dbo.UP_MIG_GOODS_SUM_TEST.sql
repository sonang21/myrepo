/* *************************************************************************
 * NAME : dbo.UP_MIG_GOODS_SUM_TEST
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2018-04-18 14:54:21.22
 *        Modify: 2018-04-18 14:54:21.22
 *        Backup: 20180521_1739
 ************************************************************************* */


CREATE PROCEDURE [dbo].[UP_MIG_GOODS_SUM_TEST]  @log_group varchar(50) = null
-- =============================================================================
...
BEGIN
    ...
    ******************************************************************************* */  
    ...
    ----------------------------------------------------------------------------
        ...
        -- truncate table MIGTEST.dbo.mig_goods_sum;
        -- RAISERROR('Test Error Injeced', 16, 1); 

        insert into MIGTEST.dbo.mig_goods_sum
             ( g_modelno
             , g_minprice
             , g_avgprice
             , g_maxprice
