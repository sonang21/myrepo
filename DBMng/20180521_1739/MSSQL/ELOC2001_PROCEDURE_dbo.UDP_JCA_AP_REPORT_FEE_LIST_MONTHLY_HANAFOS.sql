/* *************************************************************************
 * NAME : dbo.UDP_JCA_AP_REPORT_FEE_LIST_MONTHLY_HANAFOS
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2008-03-19 10:34:03.427
 *        Modify: 2018-05-03 17:23:35.95
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE PROC [dbo].[UDP_JCA_AP_REPORT_FEE_LIST_MONTHLY_HANAFOS]
	@YEAR	SMALLINT
AS
	SET NOCOUNT ON
	...
	-- 설  명 : AP 월별 수수료 리스트
	-- 실  행 : UDP_JCA_AP_REPORT_FEE_LIST_MONTHLY_HANAFOS 2008
	-- ----------------------------------------------------------------------------------
