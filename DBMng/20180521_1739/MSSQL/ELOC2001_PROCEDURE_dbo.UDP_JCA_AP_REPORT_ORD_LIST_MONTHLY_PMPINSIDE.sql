/* *************************************************************************
 * NAME : dbo.UDP_JCA_AP_REPORT_ORD_LIST_MONTHLY_PMPINSIDE
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2008-03-19 10:38:09.57
 *        Modify: 2018-05-03 17:23:36.013
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE PROC [dbo].[UDP_JCA_AP_REPORT_ORD_LIST_MONTHLY_PMPINSIDE]
	@YEAR	SMALLINT
AS
	SET NOCOUNT ON
	...
	-- 설  명 : AP 월별 주문액 리스트
	-- 실  행 : UDP_JCA_AP_REPORT_ORD_LIST_MONTHLY_PMPINSIDE 2008
	-- ----------------------------------------------------------------------------------
			...
			(
				...
				FROM	TBL_AP_SHOP_PMPINSIDE
						...
						SHOPLIST
							...
							AND shop_vcode in (5893,1733,6052,1719,6508)--SHOP_APFLAG = '1'
