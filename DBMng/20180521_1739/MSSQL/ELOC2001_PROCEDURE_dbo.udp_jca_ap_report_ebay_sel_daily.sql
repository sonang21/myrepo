/* *************************************************************************
 * NAME : dbo.udp_jca_ap_report_ebay_sel_daily
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2013-08-16 08:15:15.573
 *        Modify: 2018-05-03 17:23:35.413
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE PROC udp_jca_ap_report_ebay_sel_daily
...
AS 
	...
	*/
	...
	select shop_name, data_opt,
		...
		from tbl_ap_sales_ebay cross join (select 1 num union all select 2 union all select 3 union all select 4 union all select 5 union all select 6) bb
