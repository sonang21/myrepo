/* *************************************************************************
 * NAME : dbo.udp_make_lotte_data_1_mcate
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2011-06-21 17:07:27.167
 *        Modify: 2018-05-07 16:54:02.507
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE proc udp_make_lotte_data_1_mcate
as  
begin
	set nocount on 
	...
	*/
	...
	group by mcate, p_rank
	order by mcate, p_rank
end
