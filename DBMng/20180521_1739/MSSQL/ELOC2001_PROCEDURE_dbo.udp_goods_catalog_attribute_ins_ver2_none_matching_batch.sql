/* *************************************************************************
 * NAME : dbo.udp_goods_catalog_attribute_ins_ver2_none_matching_batch
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2014-02-28 14:22:16.533
 *        Modify: 2018-05-03 17:23:34.567
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE proc udp_goods_catalog_attribute_ins_ver2_none_matching_batch
	@mcate varchar(4)
as
	set nocount on
...
--	[2중 요약 db수정 요청분류-분류 속성순서 유지해야함]
	...
	-- 이미 매칭된 놈들은 삭제
	delete a
	from #goods_tag_del	where exists(select 1 from goods_catalog_attribute b where a.g_modelno = b.g_modelno)
	...
	-- 모델처리 : 그룹 포함하지 않은 모델 삭제
	-- delete from #goods_tag_del where is_group_spec = 0

	-- 모델처리 : 그룹 포함된 모델의 기존 설정된 속성 삭제
