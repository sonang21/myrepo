/* *************************************************************************
 * NAME : dbo.UDP_JCA_AP_REPORT_INS_ORD_HANAFOS
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2008-03-18 11:05:24.203
 *        Modify: 2018-05-03 17:23:35.227
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE PROC [dbo].[UDP_JCA_AP_REPORT_INS_ORD_HANAFOS]
	@SHOPCODE	INT,
	@YEAR		INT,
	@MONTH		INT,
	@DAY		INT,
...
AS
	...
	-- 실  행 : UDP_JCA_AP_REPORT_INS_ORD_HANAFOS 536, 2008, 12, 6, 6000
	-- ----------------------------------------------------------------------------------
