/* *************************************************************************
 * NAME : dbo.UDP_JCA_AP_REPORT_ORD_LIST_SUM_DAILY_ENURI_v3
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2014-04-14 11:20:09.663
 *        Modify: 2018-05-03 17:23:35.113
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE PROC [dbo].[UDP_JCA_AP_REPORT_ORD_LIST_SUM_DAILY_ENURI_v3]
	@sdate datetime
,	@edate datetime
,	@sale_flag char(1)
AS
