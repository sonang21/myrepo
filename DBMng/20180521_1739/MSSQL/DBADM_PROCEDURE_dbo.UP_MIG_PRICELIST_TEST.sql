/* *************************************************************************
 * NAME : dbo.UP_MIG_PRICELIST_TEST
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2018-04-18 14:50:12.58
 *        Modify: 2018-04-18 15:41:00.217
 *        Backup: 20180521_1739
 ************************************************************************* */


CREATE PROCEDURE [dbo].[UP_MIG_PRICELIST_TEST]  @partition_no int = 1, @log_group varchar(50) = null
-- =============================================================================
...
;
    ...
    ******************************************************************************* */  
    ...
    ----------------------------------------------------------------------------
        ...
        insert into MIGTEST.dbo.MIG_PRICELIST 
               ( pl_no
				 , pl_modelno
				 , pl_vcode
				 , pl_category
