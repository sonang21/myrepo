/* *************************************************************************
 * NAME : dbo.udp_jca_ap_report_ord_list_daily_enuri_pre_sales
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2011-02-08 12:54:31.29
 *        Modify: 2018-05-03 17:23:34.51
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE proc [dbo].[udp_jca_ap_report_ord_list_daily_enuri_pre_sales]
	@YEAR	SMALLINT
,	@MONTH	SMALLINT
as
	SET NOCOUNT ON
