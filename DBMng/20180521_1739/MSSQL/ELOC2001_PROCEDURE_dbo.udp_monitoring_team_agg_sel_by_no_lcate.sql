/* *************************************************************************
 * NAME : dbo.udp_monitoring_team_agg_sel_by_no_lcate
 * TYPE : PROCEDURE (SQL_STORED_PROCEDURE)
 * TIME : Create: 2012-09-25 11:05:16.19
 *        Modify: 2018-05-03 17:23:34.253
 *        Backup: 20180521_1739
 ************************************************************************* */

CREATE proc udp_monitoring_team_agg_sel_by_no_lcate
	@sdate smalldatetime
,	@edate smalldatetime
,	@monitor_no smallint
as 
	...
	from 
	(
		select  left(category,2) as category, sum(target_cnt) as tcnt, 0 as dcnt, 0 as ucnt
		...
		select left(category,2) as category, 0 tcnt, sum(delete_cnt) as dcnt, sum(update_cnt) as ucnt
