/* *************************************************************************
 * NAME : DBENURI.TR_SEN_INPRICELIST
 * TYPE : TRIGGER
 * TIME : Create: 2018-04-18 18:37:51
 *        Modify: 2018-05-21 17:25:58
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE TRIGGER "DBENURI"."TR_SEN_INPRICELIST" AFTER INSERT ON dbenuri.TBL_PRICELIST
...
--0418 v_pjobcode_new          tbl_pricelist.pjobcode          %TYPE := '';
...
--0418 v_goodsbrand_new        tbl_pricelist.goodsbrand        %TYPE := '';
       ...
       ----------------------------------------------------------------------------------------------------------------------------------------------- 
       v_minprice2             tbl_goods_sum.minprice2         %TYPE := 0; --0418 tbl_goods --> tbl_goods_sum
       v_minprice3             tbl_goods_sum.minprice3         %TYPE := 0; --0418 tbl_goods --> tbl_goods_sum
       v_socialprice           tbl_goods_sum.socialprice       %TYPE := 0; --0418 tbl_goods --> tbl_goods_sum
       ...
       v_mallcnt3              tbl_goods_sum.mallcnt3          %TYPE := 0; --0418 tbl_goods --> tbl_goods_sum
...
BEGIN
       v_modelno_new           :=  NVL(pg_Pricelist_Data.v_Modelno_new, 0);
       v_pl_no_new             :=  pg_Pricelist_Data.v_Pl_no_new;
       v_shop_code_new         :=  pg_Pricelist_Data.v_Shop_code_new;
       v_goodsnm_new           :=  NVL(pg_Pricelist_Data.v_Goodsnm_new, ' ');
       v_ca_code_new           :=  NVL(pg_Pricelist_Data.v_Ca_code_new, ' ');
--0418 v_pjobcode_new          :=  pg_Pricelist_Data.v_Pjobcode_new;
       v_jobtype_new           :=  pg_Pricelist_Data.v_Jobtype_new;
       v_price_new             :=  pg_Pricelist_Data.v_Price_new;
       v_url_new               :=  NVL(pg_Pricelist_Data.v_Url_new, ' ');
       v_imgurl_new            :=  NVL(pg_Pricelist_Data.v_Imgurl_new, ' ');
       v_imgurlflag_new        :=  pg_Pricelist_Data.v_Imgurlflag_new;
       v_u_date_new            :=  pg_Pricelist_Data.v_Udate_new;
--0418 v_searchflag_new        :=  pg_Pricelist_Data.v_Searchflag_new;
       v_goodsfactory_new      :=  NVL(pg_Pricelist_Data.v_Goodsfactory_new, ' ');
--0418 v_goodsbrand_new        :=  NVL(pg_Pricelist_Data.v_Goodsbrand_new, ' ');
    
       v_instance_price_new    :=  NVL(pg_Pricelist_Data.v_Instance_price_new,0);
       v_srvflag_new           :=  pg_Pricelist_Data.v_Srvflag_new;
       v_status_new            :=  pg_Pricelist_Data.v_Status_new;
       v_popular_new           :=  NVL(pg_Pricelist_Data.v_Popular_new,0);
       v_option_flag2_new      :=  NVL(pg_Pricelist_Data.v_option_flag2_new, '0');
       ...
       IF  v_modelno_new > 0
           AND (v_srvflag_new='0' OR v_srvflag_new='L' OR v_srvflag_new='R' OR v_srvflag_new='M') 
           ...
           IF v_option_flag2_new = '0' THEN --정상상품
               ...
               IF v_price_new < v_minprice THEN  -- 구/신 비교 
                   ----------------------------------------------------------------------------------------------------------------------------------- 
       ...
       IF v_modelno_new <= 0
           AND (v_srvflag_new='0' OR v_srvflag_new='L' OR v_srvflag_new='R') 
...
--"DBENURI"."TR_SEN_INPRICELIST" AFTER INSERT ON dbenuri.TBL_PRICELIST
--REFERENCING NEW AS NEW OLD AS OLD
--DECLARE
--       v_modelno_new           tbl_pricelist.modelno           %TYPE := 0;
--       v_pl_no_new             tbl_pricelist.pl_no             %TYPE := 0;
...
--           v_factory := '[추가]';
--           
----0418     v_goodsbrand := v_goodsbrand_new;
--           
...
--     v_goodsnm_new           :=  NVL(pg_Pricelist_Data.v_Goodsnm_new, ' ');
--     v_ca_code_new           :=  NVL(pg_Pricelist_Data.v_Ca_code_new, ' ');
--     v_pjobcode_new          :=  pg_Pricelist_Data.v_Pjobcode_new;
--     v_jobtype_new           :=  pg_Pricelist_Data.v_Jobtype_new;
--     v_price_new             :=  pg_Pricelist_Data.v_Price_new;
--     v_url_new               :=  NVL(pg_Pricelist_Data.v_Url_new, ' ');
--     v_imgurl_new            :=  NVL(pg_Pricelist_Data.v_Imgurl_new, ' ');
--     v_imgurlflag_new        :=  pg_Pricelist_Data.v_Imgurlflag_new;
--     v_u_date_new            :=  pg_Pricelist_Data.v_Udate_new;
--     v_searchflag_new        :=  pg_Pricelist_Data.v_Searchflag_new;
--     v_goodsfactory_new      :=  NVL(pg_Pricelist_Data.v_Goodsfactory_new, ' ');
--     v_goodsbrand_new      :=  NVL(pg_Pricelist_Data.v_Goodsbrand_new, ' ');
--     
--     v_instance_price_new    :=  NVL(pg_Pricelist_Data.v_Instance_price_new,0);
--     v_srvflag_new        :=  pg_Pricelist_Data.v_Srvflag_new;
--     v_status_new       :=  pg_Pricelist_Data.v_Status_new;
...
ALTER TRIGGER "DBENURI"."TR_SEN_INPRICELIST" ENABLE