/* *************************************************************************
 * NAME : DBENURI.UDP_ENURIPC_SPEC
 * TYPE : PROCEDURE
 * TIME : Create: 2018-03-28 18:50:00
 *        Modify: 2018-05-15 16:17:34
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "DBENURI"."UDP_ENURIPC_SPEC" ( logDate VARCHAR2  ) AS
/*
      ...
      open cur01;
        loop
          ...
          insert into TBL_ENURIPC_FACTORY (CATE_CODE,FACTORY,SORTNO)
            ...
            (select distinct substr(c.ca_code,0,4) ca_code,a.factory from tbl_goods a, tbl_cate_goods c where a.modelno = c.modelno and a.modelno in (
