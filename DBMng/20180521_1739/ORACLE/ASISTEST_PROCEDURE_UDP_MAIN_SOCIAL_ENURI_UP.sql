/* *************************************************************************
 * NAME : ASISTEST.UDP_MAIN_SOCIAL_ENURI_UP
 * TYPE : PROCEDURE
 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE PROCEDURE "ASISTEST"."UDP_MAIN_SOCIAL_ENURI_UP" 
IS

BEGIN

  DELETE TBL_MAIN_SOCIAL;

  INSERT INTO TBL_MAIN_SOCIAL 
  ...
  UPDATE TBL_MAIN_SOCIAL_MAN SET ENURI_UPDATE = SYSDATE;
  commit;

 EXCEPTION
     WHEN OTHERS THEN
        rollback;
        DBMS_OUTPUT.PUT_LINE('UDP_MAIN_SOCIAL_ENURI_UP error : errorcode => ' || SQLCODE || ', ERRMSG => ' || SQLERRM);
