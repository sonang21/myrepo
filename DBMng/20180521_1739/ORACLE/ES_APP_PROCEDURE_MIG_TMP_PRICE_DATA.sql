/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_PRICE_DATA
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-05 20:34:11
 *        Modify: 2018-04-06 09:12:05
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_PRICE_DATA" 
IS
...
FROM (
    ...
    AND  P.PL_NO LIKE '1%' -- OR P.PL_NO LIKE '2%' )
    AND (
      P.modelno<=0
...
BEGIN
     ...
     LOOP FETCH DATA INTO  v_ID                     
          ...
          INSERT INTO ES_APP.TMP_PRICE_DATA
                         ( ID                     
                          ,modelno                
                          ,pl_no                  
                          ,modelno_group          
