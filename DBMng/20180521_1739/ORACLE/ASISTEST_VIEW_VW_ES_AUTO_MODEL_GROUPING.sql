/* *************************************************************************
 * NAME : ASISTEST.VW_ES_AUTO_MODEL_GROUPING
 * TYPE : VIEW
 * TIME : Create: 2018-05-04 18:33:01
 *        Modify: 2018-05-04 18:33:01
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE FORCE VIEW "ASISTEST"."VW_ES_AUTO_MODEL_GROUPING" ("ID", "MODELNO", "SHOP_CODE", "GOODSNM", "GOODSFACTORY", "PRICE", "CA_CODE") AS 
  with COMP_V as (
  select '[ ]|[-]|[_]|[.]' comp_str
       , '' bank_str
       , ' ' space_str
