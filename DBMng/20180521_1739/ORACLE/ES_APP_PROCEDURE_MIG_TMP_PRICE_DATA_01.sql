/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_PRICE_DATA_01
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-05 23:16:52
 *        Modify: 2018-04-06 09:20:19
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_PRICE_DATA_01" 
IS
...
BEGIN
     ...
     LOOP FETCH DATA INTO  v_ID                     
          ...
          INSERT INTO ES_APP.TMP_PRICE_DATA_01
                         ( ID                     
                          ,modelno                
                          ,pl_no                  
                          ,modelno_group          
