/* *************************************************************************
 * NAME : DBENURI.ASIS_TRG_SEN_DELGOODS
 * TYPE : TRIGGER
 * TIME : Create: 2018-03-28 15:09:40
 *        Modify: 2018-05-11 10:51:11
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE TRIGGER "DBENURI"."ASIS_TRG_SEN_DELGOODS" AFTER DELETE ON ASIS_TBL_GOODS
DECLARE
...
ALTER TRIGGER "DBENURI"."ASIS_TRG_SEN_DELGOODS" DISABLE