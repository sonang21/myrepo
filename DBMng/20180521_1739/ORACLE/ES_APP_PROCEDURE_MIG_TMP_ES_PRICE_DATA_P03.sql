/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_ES_PRICE_DATA_P03
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-08 16:03:30
 *        Modify: 2018-04-10 12:23:44
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_ES_PRICE_DATA_P03" 
IS

EXE_SQL VARCHAR2(30000)   := '';
V_PARTITION_NO  NUMBER(3) := 3 ;
...
BEGIN
       ...
       ( 
           ...
           AND    SUBPARTITION_NAME LIKE 'PL_NO_3%' 
           /*
