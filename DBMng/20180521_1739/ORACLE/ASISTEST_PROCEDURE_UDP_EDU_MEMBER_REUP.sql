/* *************************************************************************
 * NAME : ASISTEST.UDP_EDU_MEMBER_REUP
 * TYPE : PROCEDURE
 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE PROCEDURE "ASISTEST"."UDP_EDU_MEMBER_REUP" (
...
BEGIN
   ...
   BEGIN
       ...
       UPDATE TBL_SHOPLIST SET shop_name=szShopName, email = szEmail, emailflag = szEmailFlag, tel = SHOP_PHONE,
                        ...
                        opt = '1', service = '0', es_use = '9', es_usedate = sysdate, es_mgmt = NULL, es_csi = NULL,  
                        es_stopdate = NULL, es_stop = NULL
       ...
       UPDATE TBL_NSHOP_DETAIL
              SET NS_TYPE = szNuriType, NS_COMPANYTYPE = szCompType, NS_NO = iSelectNo, NS_SHOPNAME = szShopName, NS_COMPANYNO = szCompanyNo, NS_CORPNO = szCorpNo1 || szCorpNo2,
                  ...
                  NS_NAME_DISPLAY_FLAG = szIdDisplayFlag , NS_FORMS = szForms, NS_PAYRESERVE = szPayReserve, NS_REREG_FLAG = '0'
       WHERE SHOP_CODE = szShopVcode;
