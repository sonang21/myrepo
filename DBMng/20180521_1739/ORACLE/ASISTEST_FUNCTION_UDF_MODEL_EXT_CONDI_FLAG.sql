/* *************************************************************************
 * NAME : ASISTEST.UDF_MODEL_EXT_CONDI_FLAG
 * TYPE : FUNCTION
 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE FUNCTION "ASISTEST"."UDF_MODEL_EXT_CONDI_FLAG" (v_ca_code varchar2, v_condiname varchar2, v_modelno NUMBER)
RETURN NUMBER AS
