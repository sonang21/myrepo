/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_ES_GOODS_DATA_E01
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-10 12:21:42
 *        Modify: 2018-04-10 12:21:42
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_ES_GOODS_DATA_E01" 
IS
...
BEGIN
       ...
       ( 
           ...
           AND  ( PARTITION_NAME NOT LIKE 'P01%'
           OR     PARTITION_NAME NOT LIKE 'P02%'
           OR     PARTITION_NAME NOT LIKE 'P03%'
           OR     PARTITION_NAME NOT LIKE 'P04%'
           OR     PARTITION_NAME NOT LIKE 'P05%'
           OR     PARTITION_NAME NOT LIKE 'P06%'
           OR     PARTITION_NAME NOT LIKE 'P07%'
           OR     PARTITION_NAME NOT LIKE 'P08%'
           OR     PARTITION_NAME NOT LIKE 'P09%'
           OR     PARTITION_NAME NOT LIKE 'P10%' )
