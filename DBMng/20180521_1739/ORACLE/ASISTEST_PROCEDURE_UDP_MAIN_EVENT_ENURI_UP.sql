/* *************************************************************************
 * NAME : ASISTEST.UDP_MAIN_EVENT_ENURI_UP
 * TYPE : PROCEDURE
 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE PROCEDURE "ASISTEST"."UDP_MAIN_EVENT_ENURI_UP" 
IS

BEGIN

  DELETE FROM TBL_MAIN_NEWS WHERE MN_TYPE='R';

  INSERT INTO TBL_MAIN_NEWS
 ...
 EXCEPTION
     WHEN OTHERS THEN
        ROLLBACK;
        DBMS_OUTPUT.PUT_LINE('UDP_MAIN_EVENT_ENURI_UP error : errorcode => ' || SQLCODE || ', ERRMSG => ' || SQLERRM);
