/* *************************************************************************
 * NAME : ASISTEST.UDP_GOODS_ALLNEW3
 * TYPE : PROCEDURE
 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE PROCEDURE "ASISTEST"."UDP_GOODS_ALLNEW3" (
...
BEGIN
    ...
    SELECT 'UDP_GOODS_ALLNEW3', v_ca_lcode, sysdate, sysdate, startTime, endTime, result_code, result_desc, 'START'
    FROM DUAL;
    COMMIT;
    ...
    -- SYS_LOG
    INSERT INTO TBL_SYS_PGM_LOG (PGM_NM, PGM_NM_PARA, PGM_SRT_DT, PGM_FNS_DT, startTime, endTime, result_code, result_desc, step_desc)
    SELECT 'UDP_GOODS_ALLNEW3', v_ca_lcode, sysdate, sysdate, startTime, endTime, result_code, result_desc, 'END'
    FROM DUAL;
    COMMIT;
...
EXCEPTION
    ...
    -- SYS_LOG
    INSERT INTO TBL_SYS_PGM_LOG (PGM_NM, PGM_NM_PARA, PGM_SRT_DT, PGM_FNS_DT, startTime, endTime, result_code, result_desc, step_desc)
    SELECT 'UDP_GOODS_ALLNEW3', v_ca_lcode, sysdate, sysdate, startTime, endTime, result_code, result_desc, 'END-ERROR'
    FROM DUAL;
    COMMIT;


END UDP_GOODS_ALLNEW3;