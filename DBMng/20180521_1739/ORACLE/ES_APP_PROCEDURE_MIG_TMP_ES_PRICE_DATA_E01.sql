/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_ES_PRICE_DATA_E01
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-09 11:54:35
 *        Modify: 2018-04-09 16:04:18
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_ES_PRICE_DATA_E01" 
IS

EXE_SQL VARCHAR2(30000)   := '';
V_PARTITION_NO  NUMBER(3) := 5 ;
...
BEGIN
       ...
       ( 
           ...
           AND    SUBPARTITION_NAME NOT LIKE 'PL_NO_1%' 
           AND    SUBPARTITION_NAME NOT LIKE 'PL_NO_2%' 
           AND    SUBPARTITION_NAME NOT LIKE 'PL_NO_3%' 
           AND    SUBPARTITION_NAME NOT LIKE 'PL_NO_4%' 
           AND    SUBPARTITION_NAME NOT LIKE 'SYS_SUBP5%'
           AND    SUBPARTITION_NAME NOT LIKE 'SYS_SUBP6%'
           /*
           AND    SUBPARTITION_NAME BETWEEN P_SUBPARTITION_NAME_FR
                                    AND     P_SUBPARTITION_NAME_TO 
           */
           ORDER BY SUBPARTITION_POSITION
       )  
       LOOP
  
       EXE_SQL := 'INSERT /*+ APPEND NOLOGGING */ INTO ES_APP.TMP_ES_PRICE_DATA_01 PARTITION FOR ('||TO_CHAR(V_PARTITION_NO)||')
