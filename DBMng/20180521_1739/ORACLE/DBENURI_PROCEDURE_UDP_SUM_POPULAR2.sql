/* *************************************************************************
 * NAME : DBENURI.UDP_SUM_POPULAR2
 * TYPE : PROCEDURE
 * TIME : Create: 2018-03-28 18:50:01
 *        Modify: 2018-05-16 13:18:09
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "DBENURI"."UDP_SUM_POPULAR2" (
   v_modelno   IN  NUMBER,
   v_part      IN  varchar2,
...
BEGIN
    ...
    i_count := 0;
        ...
        FOR tmp_loop in (SELECT /*+ full(g) parallel(g 4) */ distinct modelno
                           FROM TBL_GOODS g
        ...
        --================================================================================================================
        FOR tmp_loop in (SELECT /*+ full(g) parallel(g 4) */  distinct a.modelno
                           FROM TBL_GOODS a,
                                TBL_GOODS_SUM b
                          WHERE a.modelno = b.modelno
