/* *************************************************************************
 * NAME : DBENURI.TR_ORACLE_LOGOFF_LOG
 * TYPE : TRIGGER
 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE TRIGGER "DBENURI"."TR_ORACLE_LOGOFF_LOG" BEFORE LOGOFF ON DATABASE
BEGIN
...
ALTER TRIGGER "DBENURI"."TR_ORACLE_LOGOFF_LOG" ENABLE