/* *************************************************************************
 * NAME : DBENURI.PG_PRICELIST_DATA
 * TYPE : PACKAGE
 * TIME : Create: 2018-04-18 18:18:08
 *        Modify: 2018-04-23 16:56:53
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PACKAGE "DBENURI"."PG_PRICELIST_DATA" AS
...
END pg_Pricelist_Data;

------------------------------------------------------------------------------------------------------------------------------------------------------ 
-- 0418 원본 백업 
------------------------------------------------------------------------------------------------------------------------------------------------------ 
-- CREATE OR REPLACE PACKAGE "PAC_PRICELIST_DATA" AS
-- 
--  v_Modelno_old      BINARY_INTEGER := 0;
--  v_Modelno_new      BINARY_INTEGER := 0;
--  v_Pl_no_old        NUMBER(12) := 0;
