 ...
 ************************************************************************* */
  ...
  CREATE OR REPLACE PROCEDURE "ASISTEST"."UDP_CPC_MONEY" 
IS
  ...
  FOR tmp_loop in (
    ...
    IF v_realcnt > 0 THEN
        ...
        IF v_tmp_cnt = 7 THEN
            ...
            --if v_incnt <> v_realcnt THEN
            --    DBMS_OUTPUT.PUT_LINE(v_shop_code || ' ' || v_pl_no || ' ' || v_incnt || ' ' || v_avgcnt || ' ' || v_avgcnt);
            --END IF;
        END IF;
