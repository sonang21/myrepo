/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_ES_PRICE_DATA_S05
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-08 16:06:06
 *        Modify: 2018-04-10 12:24:14
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_ES_PRICE_DATA_S05" 
IS

EXE_SQL VARCHAR2(30000)   := '';
V_PARTITION_NO  NUMBER(3) := 6 ;
...
BEGIN
       ...
       ( 
           ...
           AND    SUBPARTITION_NAME LIKE 'SYS_SUBP5%' 
           /*
