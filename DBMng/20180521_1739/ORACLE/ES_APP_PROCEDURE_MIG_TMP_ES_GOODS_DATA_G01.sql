/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_ES_GOODS_DATA_G01
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-09 17:13:46
 *        Modify: 2018-04-10 12:20:16
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_ES_GOODS_DATA_G01" 
IS
...
BEGIN
       ...
       ( 
           ...
           AND  ( PARTITION_NAME LIKE 'P01%'
           OR     PARTITION_NAME LIKE 'P02%'
           OR     PARTITION_NAME LIKE 'P03%'
           OR     PARTITION_NAME LIKE 'P04%'
           OR     PARTITION_NAME LIKE 'P05%' )
