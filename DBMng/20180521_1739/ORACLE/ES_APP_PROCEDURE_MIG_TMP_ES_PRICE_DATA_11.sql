/* *************************************************************************
 * NAME : ES_APP.MIG_TMP_ES_PRICE_DATA_11
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-06 14:46:37
 *        Modify: 2018-04-09 09:55:13
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "ES_APP"."MIG_TMP_ES_PRICE_DATA_11" 
IS
...
BEGIN
       ...
       EXE_SQL := 'INSERT /*+ APPEND NOLOGGING */ INTO ES_APP.TMP_ES_PRICE_DATA_11
                  ( ID               ,MODELNO          ,PL_NO            ,MODELNO_GROUP  
                   ...
                   ,MINPRICE5        ,EXT_CONDI_FLAG   ,PARTITION_NO
                   ) '
       ||
       'SELECT /*+ PARALLEL(5) */
              ''P'' || P.PL_NO                                                                                      AS ID
