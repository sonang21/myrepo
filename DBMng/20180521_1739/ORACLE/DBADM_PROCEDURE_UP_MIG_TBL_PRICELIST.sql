/* *************************************************************************
 * NAME : DBADM.UP_MIG_TBL_PRICELIST
 * TYPE : PROCEDURE
 * TIME : Create: 2018-04-02 12:53:16
 *        Modify: 2018-04-19 18:44:46
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "DBADM"."UP_MIG_TBL_PRICELIST" (P_VALUE VARCHAR2 DEFAULT NULL)
-- =============================================================================
...
BEGIN
    ...
    ******************************************************************************* */  
    ...
    INSERT /*+ APPEND */ INTO dbenuri.MIG_PRICELIST
         ( MODELNO                      
         , SHOP_CODE              
         , GOODSNM                
         , CA_CODE                
