/* *************************************************************************
 * NAME : DBENURI.TR_SEN_UPGOODS
 * TYPE : TRIGGER
 * TIME : Create: 2018-05-11 12:28:19
 *        Modify: 2018-05-21 17:20:39
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE TRIGGER "DBENURI"."TR_SEN_UPGOODS" AFTER UPDATE ON TBL_GOODS
DECLARE
       ...
       v_minprice_new              tbl_goods_sum.minprice%TYPE        := 0;
       ...
       v_sum_popular_old           tbl_goods_sum.sum_popular%TYPE     := 0;
       v_sum_popular_new           tbl_goods_sum.sum_popular%TYPE     := 0;    
       v_sale_cnt_old              tbl_goods_sum.sale_cnt%TYPE        := 0;
       v_sale_cnt_new              tbl_goods_sum.sale_cnt%TYPE        := 0;
--0418 v_gbcnt_old                 tbl_goods.gbcnt%TYPE               := 0;
--0418 v_gbcnt_new                 tbl_goods.gbcnt%TYPE               := 0;
       v_ca_code_old               tbl_cate_goods.ca_code%TYPE        := '';
       v_ca_code_new               tbl_cate_goods.ca_code%TYPE        := '';
       ...
       v_cateflag_new              tbl_cate_goods.cateflag%TYPE       := '';
...
--0418 v_info_sum_point_new        tbl_goods.info_sum_point%TYPE      := 0;
       ...
       v_minprice2_old             tbl_goods_sum.minprice2%TYPE       := 0;
       v_minprice2_new             tbl_goods_sum.minprice2%TYPE       := 0;    
       v_minprice3_old             tbl_goods_sum.minprice3%TYPE       := 0;
       v_minprice3_new             tbl_goods_sum.minprice3%TYPE       := 0;
       v_minprice4_old             tbl_goods_sum.minprice4%TYPE       := 0;
       v_minprice4_new             tbl_goods_sum.minprice4%TYPE       := 0;
    
       v_bbs_num_old               tbl_goods_sum.bbs_num%TYPE         := 0;
       v_bbs_num_new               tbl_goods_sum.bbs_num%TYPE         := 0;
  ...
  --SET SERVEROUTPUT ON
    DBMS_OUTPUT.ENABLE;
    DBMS_OUTPUT.PUT_LINE('trgSenUpGoods start ......' || pg_Goods_DataLoop.g_index);
    ...
    LOOP
        IF i <= pg_Goods_DataLoop.g_index THEN
            ...
            v_spec_old                               :=  NVL(pg_Goods_DataLoop.v_Spec_old(i),'');
            v_spec_new                               :=  NVL(pg_Goods_DataLoop.v_Spec_new(i),'');
     ...
     --0502 v_mallcnt_new                            :=  pg_Goods_DataLoop.v_Mallcnt_new(i);
     ...
     --0502 v_popular_old                            :=  NVL(pg_Goods_DataLoop.v_Popular_old(i),0);
     --0502 v_popular_new                            :=  NVL(pg_Goods_DataLoop.v_Popular_new(i),0);
     --0502 v_sum_popular_old                        :=  NVL(pg_Goods_DataLoop.v_Sum_popular_old(i),0);
     --0502 v_sum_popular_new                        :=  NVL(pg_Goods_DataLoop.v_Sum_popular_new(i),0);        
     --0502 v_sale_cnt_old                           :=  pg_Goods_DataLoop.v_Sale_cnt_old(i);
     ...
     --0502 v_ca_code_new                            :=  pg_Goods_DataLoop.v_Ca_code_new(i);
            v_modelno_group_old                      :=  NVL(pg_Goods_DataLoop.v_Modelnogroup_old(i),0);
            ...
            v_keyword2_old                           :=  pg_Goods_DataLoop.v_Keyword2_old(i);
            v_keyword2_new                           :=  pg_Goods_DataLoop.v_Keyword2_new(i);
            v_brand_old                              :=  pg_Goods_DataLoop.v_Brand_old(i);
            v_brand_new                              :=  pg_Goods_DataLoop.v_Brand_new(i);
            
            v_jobcode_old                            :=  pg_Goods_DataLoop.v_Jobcode_old(i);
            v_jobcode_new                            :=  pg_Goods_DataLoop.v_Jobcode_new(i);
     ...
     --0502 v_cateflag_new                           :=  pg_Goods_DataLoop.v_Cateflag_new(i);
            ...
            v_constrain_new                          :=  pg_Goods_DataLoop.v_Constrain_new(i);
            v_moddate_old                            :=  NVL(pg_Goods_DataLoop.v_Moddate_old(i), sysdate);
            v_moddate_new                            :=  NVL(pg_Goods_DataLoop.v_Moddate_new(i), sysdate);
            v_pl_no_old                              :=  NVL(pg_Goods_DataLoop.v_Pl_no_old(i), 0);
            v_pl_no_new                              :=  NVL(pg_Goods_DataLoop.v_Pl_no_new(i), 0);
            v_imgurl_new                             :=  NVL(pg_Goods_DataLoop.v_Imgurl_new(i), '');
            v_imgurlflag_new                         :=  NVL(pg_Goods_DataLoop.v_Imgurlflag_new(i), '');
     --0502 v_rsiflag_old                            :=  NVL(pg_Goods_DataLoop.v_Rsiflag_old(i), '');
     --0502 v_rsiflag_new                            :=  NVL(pg_Goods_DataLoop.v_Rsiflag_new(i), '');
            v_refshop_old                            :=  NVL(pg_Goods_DataLoop.v_Refshop_old(i), '');
            v_refshop_new                            :=  NVL(pg_Goods_DataLoop.v_Refshop_new(i), '');
     ...
     --0418 v_boxmodelnm_new                         :=  pg_Goods_DataLoop.v_Boxmodelnm_new(i);
            ...
            v_weight_old                             :=  pg_Goods_DataLoop.v_Weight_old(i);
     --0418 v_info_sum_point_new                     :=  pg_Goods_DataLoop.v_Info_sum_point_new(i);
     --0418 v_info_sum_point_old                     :=  pg_Goods_DataLoop.v_Info_sum_point_old(i);
            ...
            v_condiname_old                          :=  pg_Goods_DataLoop.v_Condiname_old(i);        
            v_condiname_new                          :=  pg_Goods_DataLoop.v_Condiname_new(i);        
            v_flag_old                               :=  pg_Goods_DataLoop.v_flag_old(i);
            v_flag_new                               :=  pg_Goods_DataLoop.v_flag_new(i);
            ----------------------------------------------------------------------------------------------------------------------------------------------- 
     --0502 v_minprice2_old                          :=  pg_Goods_DataLoop.v_Minprice2_old(i);
     --0502 v_minprice2_new                          :=  pg_Goods_DataLoop.v_Minprice2_new(i);        
     --0502 v_minprice3_old                          :=  pg_Goods_DataLoop.v_Minprice3_old(i);
     --0502 v_minprice3_new                          :=  pg_Goods_DataLoop.v_Minprice3_new(i);
     
     --0502 v_minprice4_old                          :=  pg_Goods_DataLoop.v_Minprice4_old(i);
     --0502 v_minprice4_new                          :=  pg_Goods_DataLoop.v_Minprice4_new(i);
     
     --0502 v_bbs_num_old                            :=  pg_Goods_DataLoop.v_BBs_Num_old(i);
     --0502 v_bbs_num_new                            :=  pg_Goods_DataLoop.v_Bbs_Num_new(i);
           ...
           ----------------------------------------------------------------------------------------------------------------------------------------------- 
            IF  nvl(v_jobcode_old, '0') <> '0' AND (v_constrain_old = '1' OR v_constrain_old = '5')     THEN -- 서비스_OLD
                IF  nvl(v_jobcode_new, '0') <> '0' AND (v_constrain_new = '1' OR v_constrain_new = '5') THEN -- 서비스_NEW
                    IF (v_modelno_group_old <>  v_modelno_group_new) --0502 goods
                         OR (v_spec_old          <>  v_spec_new)          --0502 goods
                         OR (v_factory_old       <>  v_factory_new)       --0502 goods
                         OR (v_modelnm_old       <>  v_modelnm_new)       --0502 goods
                         OR (v_condiname_old     <>  v_condiname_new)     --0502 goods
                         -- SUM_MOD_DATE 비교?
                    THEN
                        v_status_tmp := 'I'; --추가
                    END IF;
                ELSE
                    IF v_modelno_group_new > 0 THEN
                        v_status_tmp := 'I'; --삭제-- 여기서는 'I' 이지만 서비스중이 아니므로 v_status_tmp = 'D'로 변경됨
                    ELSE
                        v_status_tmp := 'D'; --삭제
                    END IF;
            ...
            ----------------------------------------------------------------------------------------------------------------------------------------------- 
            -- 0505 이주현
            -- tbl_goods.flag 모델변경 코드0 : 변경없음1 : 변경있음  
            -- (잘 모르겠음,OR substr(v_ca_code_new,0,4)='8701' 조건은 삭제)
            -----------------------------------------------------------------------------------------------------------------------------------------------                            
             IF (v_flag_old is null AND v_flag_new = '0') THEN
                 v_status_tmp := 'I';
             END IF;
            ----------------------------------------------------------------------------------------------------------------------------------------------- 
            -- 0505 이주현
            -- v_status_tmp = 'X' 삭제 후보 
            -- 나중에 ES에서 색인할때 mallcnt = 0 이면 진짜 삭제
            -----------------------------------------------------------------------------------------------------------------------------------------------          
             IF  v_constrain_new = '5' THEN
                 v_status_tmp := 'X';
             END IF;
            ----------------------------------------------------------------------------------------------------------------------------------------------- 
            -- 0505 이주현
            -- v_status_tmp = 'U' 인 경우 없으므로 조건에서 삭제
            -----------------------------------------------------------------------------------------------------------------------------------------------                   
            v_modelno := v_modelno_new;
            
            --DBMS_OUTPUT.PUT_LINE('v_status_tmp  : ' || v_status_tmp);
            --DBMS_OUTPUT.PUT_LINE('v_modelno     : ' || v_modelno);
            --DBMS_OUTPUT.PUT_LINE('v_modelno_old : ' || v_modelno_old);
            --DBMS_OUTPUT.PUT_LINE('v_modelno_new : ' || v_modelno_new);
    
            IF v_status_tmp='I' OR v_status_tmp='X' OR v_status_tmp='D' THEN
                --v_modelno := v_modelno_new;
                ----------------------------------------------------------------------------------------------------------------------------------------------- 
                -- 0505 이주현
                -- 서비스 중이 아닌 모델은 v_status_tmp := 'D'로 변경
                -----------------------------------------------------------------------------------------------------------------------------------------------                                
                IF v_status_tmp='I' OR v_status_tmp='D' OR v_status_tmp='X' OR v_modelno_group_new > 0 THEN --입력이거나 그룹모델일 경우만
                    BEGIN 
                        select NVL(COUNT(*),0) 
                          INTO v_exist_cnt
                          FROM tbl_goods 
...
--"DBENURI"."TR_SEN_UPGOODS" AFTER UPDATE ON TBL_GOODS
--DECLARE
--       v_modelno_old               tbl_goods.modelno%TYPE             := 0;
--       v_modelno_new               tbl_goods.modelno%TYPE             := 0;
--       v_modelnm_old               tbl_goods.modelnm%TYPE             := '';
...
--                     -- 참고 0502 
--                     --------------------------------------------------------------------------------------------------------------------------------- 
--                     -- 1안 : 임시 테이블(TBL_GOODS_SUM_OLD) 이용시  SELECT 절 추가 
--                     --                 TBL_GOODS_SUM : NEW -> 트리거 추가 --> TBL_GOODS_SUM_OLD 
--                     -- 2안 : IF 조건 제거 
--                     --------------------------------------------------------------------------------------------------------------------------------- 
--                   
--                     IF v_cateflag_old = '1' OR (v_mallcnt_old=0     AND v_mallcnt_new>0)     --0502 GOODS_SUM
--                                             OR (v_mallcnt_old>0     AND v_mallcnt_new=0)     --0502 GOODS_SUM
--                                             OR (v_popular_old       <>  v_popular_new)       --0502 GOODS_SUM
--                                             OR (v_sum_popular_old   <>  v_sum_popular_new)   --0502 GOODS_SUM
--                                             OR (v_minprice3_old     <>  v_minprice3_new)     --0502 GOODS_SUM
--                                             OR (v_minprice4_old     <>  v_minprice4_new)     --0502 GOODS_SUM 
--                                             OR (v_bbs_num_old       <>  v_bbs_num_new)       --0502 GOODS_SUM
--                                             
--                                             OR (v_ca_code_old       <>  v_ca_code_new)       --0502 CATE_GOODS
--                                             
--                                             OR (v_modelno_group_old <>  v_modelno_group_new) --0502 goods
--                                             OR (v_spec_old          <>  v_spec_new)          --0502 goods
--                                             OR (v_factory_old       <>  v_factory_new)       --0502 goods
--                                             OR (v_modelnm_old       <>  v_modelnm_new)       --0502 goods
--                                             OR (v_condiname_old     <>  v_condiname_new)     --0502 goods
...
--         --추가분류 데이타, 소셜상품
--         --------------------------------------------------------------------------------------------------------------------------------------------- 
--         IF (v_flag_old is null AND v_flag_new = '0') 
--             OR substr(v_ca_code_new,0,4)='8701' THEN  --0502 CATE_GOODS 
--             v_status_tmp := 'I';
--         END IF;
--         
...
--                            dbenuri.UDF_RTN_GET_SPECOPT(NVL(modelno_group,MAX(a.modelno))) AS SPECOPT,
--                          --'' AS SPECOPT,
...
--                            UDF_RTN_GET_DEPT_CA_CODE(NVL(modelno_group,MAX(a.modelno))) ca_dept_code,
--                            
--                            
...
--                            UDF_BBS_NUM_SUM(NVL(modelno_group,MAX(a.modelno))) bbs_num,
--                            'I'
--                     
--                      INTO
--                     
...
--                      WHERE ((v_modelno_group_new>0 and modelno_group = v_modelno_new) OR (v_modelno_group_new=0 AND A.modelno = v_modelno_new))
--                        AND jobcode > '0' 
--                        AND constrain IN ('1','5')
...
--                               from tbl_cate_goods 
--                              where cateflag = '0' ) b
--                      WHERE (A.modelno_group = v_modelno_group_old)
--                        AND  A.jobcode > '0' 
--                        AND  A.constrain = '1' 
--                        ------------------------------------------------------------------------------------------------------------------------------ 
--                        -- 0418 테이블분리에 따른 수정 
...
ALTER TRIGGER "DBENURI"."TR_SEN_UPGOODS" ENABLE