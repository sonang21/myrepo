/* *************************************************************************
 * NAME : DBENURI.UDP_BID_SCHEDULE
 * TYPE : PROCEDURE
 * TIME : Create: 2018-03-28 18:50:00
 *        Modify: 2018-05-15 12:45:12
 *        Backup: 20180521_1739
 ************************************************************************* */


  CREATE OR REPLACE PROCEDURE "DBENURI"."UDP_BID_SCHEDULE" 
IS
/*
...
BEGIN
    ...
    FOR tmp_loop in (SELECT PL_NO as pl_no, BID_UNIT_PRICE as bid_unit_price
    ...
    LOOP
      BEGIN
        ...
        BEGIN
          ...
          SELECT a.ca_code,a.modelno
            INTO v_ca_code,v_modelno 
            FROM TBL_GOODS a, 
                 TBL_PRICELIST b
