...
C:\App\Java\jdk1.6.0_45\bin\java -Xmx512m -XX:PermSize=256m -XX:MaxPermSize=256m -XX:NewSize=128m -cp %class_path% com.cslee.dqm.DQMain %1 %2 %3 %4 %5 %6 %7 %8
